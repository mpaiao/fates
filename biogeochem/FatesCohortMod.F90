module FatesCohortMod
  ...
  contains
    ...
    subroutine Dump(this)
      ...
      write(fates_log(),*) 'cohort%status_coh             = ', this%status_coh
      write(fates_log(),*) 'cohort%efleaf_coh             = ', this%efleaf_coh
      write(fates_log(),*) 'cohort%effnrt_coh             = ', this%effnrt_coh
      write(fates_log(),*) 'cohort%efstem_coh             = ', this%efstem_coh
      write(fates_log(),*) 'cohort%vcmax25top             = ', this%vcmax25top
      write(fates_log(),*) 'cohort%jmax25top              = ', this%jmax25top
      write(fates_log(),*) 'cohort%kp25top                = ', this%kp25top
